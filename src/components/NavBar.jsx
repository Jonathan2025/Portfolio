  ...
  return (
    ...
    {/* This will be the menu */}
            <ul className="hidden md:flex"> 
                ...
                <li>
                    <Link to="current" smooth={true} duration={500}>
                        Current Work
                    </Link>
                </li>
                <li>
        ...
        <ul className={!nav ? 'hidden' : 'absolute top-0 left-0 w-full h-screen bg-[#0284c7] flex flex-col justify-center items-center'}> 
                ...
                <li className='py-6 text-4xl'>
                    <Link onClick={handleClick} to="current" smooth={true} duration={500}>
                        Current Work
                    </Link>
                </li>
                <li className='py-6 text-4xl'>
        ...
        <div className="hidden lg:flex fixed flex-col top-[35%] left-0"> 
            <ul>
                ...
                <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[10px] duration-300 bg-[#FFBF00]'> 
                    <a className='flex justify-between items-center w-full text-white' 
                    href="https://drive.google.com/file/d/1nPICspGUztQNjqlyM1ojAveUpbvWdg2Y/view?usp=drive_link" target="_blank">
