...
const Home = () => {
  return (
    <div name="home" className="w-full h-screen bg-[#72a8d5]">
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <h2 className="text-4xl sm:text-7xl font-bold text-[gray]">Full Stack Software Engineer</h2>
            {/* on larger screens this is so that the p tag doesnt take the full page */}
            <p className ="text-[gray] py-4 max-w-[700px]">I am a full stack software engineer that specializes and loves to 
